...
public class SodiumConfigBuilder {
  ...
  private static class Enabler {
    ...
    public Enabler(
        Predicate<ConfigState> tester, ResourceLocation[] dependencies, boolean joinParent) {
      this.tester = tester;
  ...
  public abstract static class Enableable<TYPE extends Enableable<TYPE>> {
    ...
    private TYPE parentEnablerUpdate(Enableable parent) {
      if (this.enabler == null) {
        ...
        this.setEnabler0(parent.enabler);
      } else if (this.enabler.inheritedEnabler != null
          && this.enabler.inheritedEnabler == parent.prevEnabler) {
    ...
    public TYPE setEnablerInherit(
        Predicate<ConfigState> enabler, ResourceLocation... dependencies) {
      return this.setEnabler0(new Enabler(enabler, dependencies, true));
    }
  ...
  public abstract static class Option<
          TYPE,
          OPTION extends Option<TYPE, OPTION, STYPE>,
          STYPE extends StatefulOptionBuilder<TYPE>>
  ...
  public static class IntOption extends Option<Integer, IntOption, IntegerOptionBuilder> {
    ...
    protected IntegerOptionBuilder create(ConfigBuilder builder, BuildCtx ctx) {
      ...
      if (this.rangeDependencies == null || this.rangeDependencies.length == 0) {
        ...
        option.setRangeProvider(
            (Function<ConfigState, SteppedValidator>) (Object) this.rangeProvider,
            mapIds(this.rangeDependencies));
      }
  ...
  public static class BoolOption extends Option<Boolean, BoolOption, BooleanOptionBuilder> {
    ...
    public BoolOption(
        String id, Component name, Supplier<Boolean> getter, Consumer<Boolean> setter) {
      super(id, name, getter, setter);
    }
  ...
  public static class EnumOption<T extends Enum<T>>
      extends Option<T, EnumOption<T>, EnumOptionBuilder<T>> {
    private final Class<T> theEnum;
    private Function<T, Component> nameProvider =
        value -> Component.literal(value == null ? "NULL" : value.toString());
    ...
    public EnumOption(
        String id, Class<T> theEnum, Component name, Supplier<T> getter, Consumer<T> setter) {
      super(id, name, getter, setter);
      this.theEnum = theEnum;
    }
  ...
  public static class PostApplyOps implements FlagHook {
    private record Hook(
        ResourceLocation name, Runnable runnable, Set<ResourceLocation> conflicts) {}
    ...
    public PostApplyOps register(
        ResourceLocation name, Runnable postRunner, ResourceLocation... conflicts) {
  ...
  public static void buildToSodium(
      ...
      Consumer<PostApplyOps> registerOps,
      Page... pages) {
